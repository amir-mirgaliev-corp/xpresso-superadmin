...
import translateWeeksDay from '@/utils/translateWeekDays';
import translateYearMoths from '@/utils/translateYearMoths';
...
export default {
    ...
    methods: {
        ...
        translateDateToWeek () {
            return translateWeeksDay('ru', this.graph.labels);
        },
